...
public class Loader {
	...
	public int loadTexture(String fileName) {
        ...
        GL11.glTexParameterf(textureID, EXTTextureFilterAnisotropic.GL_TEXTURE_MAX_ANISOTROPY_EXT, max_a.get(0));*/
	...
	private void bindIndicesBuffer(int[] indices) {
		...
		IntBuffer buffer = storeDataInIntBufeer(indices);
		GL15.glBufferData(GL15.GL_ELEMENT_ARRAY_BUFFER, buffer, GL15.GL_STATIC_DRAW);
	}
	
	private IntBuffer storeDataInIntBufeer(int[] data) {
